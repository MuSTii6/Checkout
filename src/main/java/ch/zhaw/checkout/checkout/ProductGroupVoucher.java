...
public class ProductGroupVoucher implements Voucher {
    ...
    private int amount;
    static String errorMessageProductBlank = "Error: Product group isn't allowed to be blank.";
    static String errorMessageProductNull = "Error: Product group isn't allowed to be null.";
    static String errorMessageAmount = "Error: Amount has to be a positive value.";
